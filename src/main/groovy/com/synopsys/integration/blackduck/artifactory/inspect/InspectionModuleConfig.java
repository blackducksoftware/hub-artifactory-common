...
public class InspectionModuleConfig extends ModuleConfig {
    ...
    public static InspectionModuleConfig createFromProperties(final BlackDuckPropertyManager blackDuckPropertyManager, final List<String> repoKeys) {
        final boolean enabled = blackDuckPropertyManager.getBooleanProperty(InspectModuleProperty.ENABLED);
        final String blackDuckIdentifyArtifactsCron = blackDuckPropertyManager.getProperty(InspectModuleProperty.IDENTIFY_ARTIFACTS_CRON);
        final String blackDuckPopulateMetadataCron = blackDuckPropertyManager.getProperty(InspectModuleProperty.POPULATE_METADATA_CRON);
        final String blackDuckUpdateMetadataCron = blackDuckPropertyManager.getProperty(InspectModuleProperty.UPDATE_METADATA_CRON);
