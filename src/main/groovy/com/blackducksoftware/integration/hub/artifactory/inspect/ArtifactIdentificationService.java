...
public class ArtifactIdentificationService {
    ...
    public ArtifactIdentificationService(final Repositories repositories, final Searches searches, final PackageTypePatternManager packageTypePatternManager, final ArtifactoryExternalIdFactory artifactoryExternalIdFactory, final ArtifactoryPropertyService artifactoryPropertyService, final CacheInspectorService cacheInspectorService, final HubConnectionService hubConnectionService) {
    ...
    public void identifyArtifacts(final String repoKey) {
        ...
        try {
            ...
            if (matchedArtifacts.isPresent()) {
                ...
                logger.warn(String.format("The blackDuckCacheInspector could not identify artifacts in repository %s because no supported patterns were found. The repository either uses an unsupported package manager or no patterns were configured for it.", repoKey));
            }
